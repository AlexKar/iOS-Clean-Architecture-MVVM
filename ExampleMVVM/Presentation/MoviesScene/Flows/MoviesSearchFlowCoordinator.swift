...
final class MoviesSearchFlowCoordinator {
    ...
    private func showMovieDetails(movie: Movie, listener: MoviesListListener) {
        let vc = dependencies.makeMoviesDetailsViewController(movie: movie, listener: listener)
